...
public class UpdateAction implements OrganizationsAction {
  ...
  public void handle(Request request, Response response) throws Exception {
    ...
    UpdateOrganizationRequest updateRequest = new UpdateOrganizationRequest(
      ...
      request.getParam(PARAM_DESCRIPTION, (rqt, paramKey) -> wsSupport.getAndCheckDescription(rqt)),
      request.getParam(PARAM_URL, (rqt, paramKey) -> wsSupport.getAndCheckUrl(rqt)),
      request.getParam(PARAM_AVATAR_URL, (rqt, paramKey) -> wsSupport.getAndCheckAvatar(rqt)));
